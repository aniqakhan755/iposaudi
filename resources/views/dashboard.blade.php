            ...
            <div class="element-wrapper">
                ...
                <div class="element-box-tp">
                    <div class="el-buttons-list full-width">
                        <a class="btn btn-white btn-sm" href="{{route('manage.sliders')}}"><span>Manage Sliders</span></a>
                        <a class="btn btn-white btn-sm" href="{{route('manage.about')}}"><span>Manage About</span></a>
                        <a class="btn btn-white btn-sm" href="{{route('manage.services')}}"><span>Manage Services</span></a>
                    </div>
                </div>
            </div>
        </div>
