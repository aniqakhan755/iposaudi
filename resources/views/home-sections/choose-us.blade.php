                ...
                <div id="accordion" class="accordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" data-parent="#accordion">
                            <div class="card-body"><div class="desc"><?php echo($desc1)?> @if(strlen($choose_configuration->heading1_desc) > 220) <a href="{{route('choose-us.read-more')}}">Read More</a> @endif</div></div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div id="collapseTwo" class="collapse" data-parent="#accordion">
                            <div class="card-body"><?php echo($desc2)?> @if(strlen($choose_configuration->heading2_desc) > 200) <a href="{{route('choose-us.read-more')}}">Read More</a> @endif</div>
                        </div>
                    </div>
                </div>
            </div>
